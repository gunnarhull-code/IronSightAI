...
2. Fetch the Issue with `gh`; treat its scope as **frozen**. Stop if missing or ambiguous.
...
7. Update `management/AFK_AGENTS.md` only if this is AFK/Cloud assigned work.
